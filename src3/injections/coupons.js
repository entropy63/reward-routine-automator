...
// the Coupons button. Injected via chrome.scripting.executeScript({func}),
// which serializes the function's source, so each function must be fully
// self-contained: no imports, no closures over module state (see ADR-017).
