...
// keep earning steps, and the page-side claim routine. Injected via
...
export function openRewardsSectionTiles(names, maxOpen, label, skipSpent) {
...
export function claimDashboardPoints(timeoutMs) {
  return new Promise(resolve => {
